...
are regenerable and, in most cases, too large for git, except for the three summary 
tables below, which are kept so the final site-level data can be explored without 
